...
class VoiceControlNavNode:
    def __init__(self, name):
        ...
        self.costmap = rospy.get_param('~costmap', 'rospider/move_base/local_costmap/costmap') 
        self.map_frame = rospy.get_param('~map_frame', 'map')
        self.mecanum_pub = rospy.Publisher('/rospider/rospider_controller/cmd_vel', Twist, queue_size=1)
        self.goal_pub = rospy.Publisher('/rospider/move_base_simple/goal', PoseStamped, queue_size=1)
        self.goal_status_pub = rospy.Publisher('/rospider/move_base/result', MoveBaseActionResult, queue_size=1)
