...
class ColorTrackingNode:
    def __init__(self, target_color, log_level=rospy.INFO):
        ...
        self.pid_yaw = pid.PID(0.08, 0.0, 0.0005) # 控制偏航角的 pid 控制器
    ...
    def image_callback(self, ros_image: Image):
        ...
        rgb_image = cv2.resize(rgb_image, (int(ros_image.width/2), int(ros_image.height/2)), cv2.INTER_NEAREST) # 缩放图片
