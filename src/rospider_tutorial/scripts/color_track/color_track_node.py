...
from rospider_interfaces.msg import ColorsInfo, ColorDetect
from rospider_interfaces.srv import SetColorDetectParam, SetString
    ...
    def color_track(self):
        while self.running:
            if self.center is not None and self.start:
                ...
                serial_servo.set_position(19, int(self.x_dis), 0)
